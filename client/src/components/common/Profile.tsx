...
const Profile = ({ type, name, avatar, email, companies }: ProfileProps) => (
  <Box>
              ...
              <Stack direction="column" gap="30px">
                {/* <Stack gap="15px">
                  ...
                  <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
                    ...
                    <Typography fontSize={14} color="#11142D">4517 Whittier Avenue, Stonecrest 30095</Typography>
                  </Box>
                </Stack> */}
                ...
                <Stack direction="row" flexWrap="wrap" gap="20px" pb={4}>
                  {/* <Stack flex={1} gap="15px">
                    ...
                    <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
                      ...
                      <Typography fontSize={14} color="#11142D" noWrap>+1 404 567 9890</Typography>
                    </Box>
                  </Stack> */}
    ...
    <Box
      ...
      bgcolor="#FCFCFC"
    >
      <Typography fontSize={18} fontWeight={600} color="#11142D">{type} Gigs</Typography>
      ...
      >
        {companies?.map((company: PropertyProps) => (
          <PropertyCard key={company._id} id={company._id}
            title={company.title}
